...
sys.path.append(parent(parent(os.getcwd())))
...
# documentation.
html_theme_options = {'github_fork': False, 'index_logo': 'flask-xmlrpc.png'}
...
intersphinx_mapping = {'http://flask.pocoo.org/docs/': None}
